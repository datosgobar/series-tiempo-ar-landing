/*
  Producto: MODAL
  Descripción: Sistema de modularización de contenido
  ...
  module: {
    ...
    simple: (structureParams) => {
      ...
      let options = {
        ...
        default: {html: 'div', class: 'modalContainer'}
      };
      ...
      injectStyles(responsive, structure.settings.specialStyles);
  ...
  add: {
    ...
    subContainer: (structureParams) => {
      ...
      let options = {
        ...
        card:    {html: 'section', class: 'cardContainer'},
